...
import { StudentComponent4 } from './student4.component';
...
describe('StudentComponent4', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [StudentComponent4],
      providers: [
  ...
  it('should set todo correctly from service', () => {
    const fixture = TestBed.createComponent(StudentComponent4);
