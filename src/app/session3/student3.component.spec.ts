...
import { StudentComponent3 } from './student3.component';
...
describe('StudentComponent3', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [StudentComponent3],
      providers: [
  ...
  it('should set todo correctly from service', () => {
    const fixture = TestBed.createComponent(StudentComponent3);
